...
Una `PoliticaSconto` ha un metodo `calcolaSconto` che restituisce lo sconto per l’acquisto di un certo numero di articoli tutti dello stesso tipo. La classe ha due attributi, `numeroArticoli` e `prezzoArticolo`.
...
Progettare, specificare ed implementare le classi descritte
