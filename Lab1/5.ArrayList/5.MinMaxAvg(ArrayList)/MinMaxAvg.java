...
public class MinMaxAvg {
	...
	public static void main(String[] args) {
		...
		List<Integer> values = new ArrayList<>(); //nuovo ArrayList. Uso come tipo List che è l'interfaccia implementata da ArrayList (e altri). Uso le generics per restringere il tipo di dato a Integer
	...
	public static int minimo(List<Integer> in) {
		int min = in.get(0);
		for (int i=1;i<in.size();i++) //for classico. uso il metodo size() per sapere la dimensione della List.
