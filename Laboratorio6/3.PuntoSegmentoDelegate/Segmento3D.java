...
public class Segmento3D implements Segmento { //è inutile ereditare Segmento2D perchè la sua rappresentazione non sarebbe riusabile. Quando non si riusa la rep ma solo le intestazioni dei metodi è meglio utilizzare interfacce comuni.
//OVERVIEW: classe che modella un Segmento nello spazio (immutabile)
	...
	//EFFECTS: returns the length of the segment;
		...
		double c3 = (this.getA().getZ() - this.getB().getZ());
