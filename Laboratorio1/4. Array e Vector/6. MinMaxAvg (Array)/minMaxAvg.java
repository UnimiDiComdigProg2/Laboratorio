...
public class minMaxAvg { //classe pubblica al fine di poterla importare da altre classi e package
    ...
    public static int minimo(int[] in) {
        ...
        int min = Integer.MAX_VALUE; //nella classe Integer posso leggere il valore massimo degli interi su questa macchina. sicuramente i numeri inseriti saranno più piccoli di questo valore

        for (int i=0;i<in.length;i++) { //posso fare un ciclo for classico per accedere ai valori per indice
    ...
    public static int massimo(int[] in) {
        ...
        int max = Integer.MIN_VALUE; //come prima ma leggo il valore int minimo possibile
